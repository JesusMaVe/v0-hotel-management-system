            ...
            >
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span
                    className={`text-sm font-medium ${getTrendColor(metric.trend, metric.change)}`}
                  >
                    {metric.change > 0 ? "+" : ""}
                    {metric.change}%
                  </span>
          ...
          <div className="space-y-4">
            <div className="p-3 rounded-lg bg-success/10 border border-success/20">
              ...
              <p className="text-sm text-muted-foreground">
                Los ingresos aumentaron 15.2% gracias a la optimización de
                precios dinámicos y eventos corporativos.
              </p>
            </div>
            ...
            <div className="p-3 rounded-lg bg-accent/10 border border-accent/20">
              ...
              <p className="text-sm text-muted-foreground">
                La puntuación de satisfacción alcanzó 4.7/5, impulsada por
                mejoras en el servicio de spa y restaurante.
              </p>
            </div>
            ...
            <div className="p-3 rounded-lg bg-warning/10 border border-warning/20">
              ...
              <p className="text-sm text-muted-foreground">
                Ligera disminución en huéspedes únicos (-3.2%). Implementar
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={index} className="space-y-2">
                ...
                <div className="flex items-center space-x-2">
                  <Progress
                    value={Math.min(item.achievement, 100)}
