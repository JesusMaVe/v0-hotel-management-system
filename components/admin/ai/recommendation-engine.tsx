...
<<<<<<< HEAD:components/ai/recommendation-engine.tsx
...
>>>>>>> be72ef3 (añadiendo los gráficos estadísticos):components/admin/ai/recommendation-engine.tsx
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-start space-x-3">
                <div
                  className={`p-2 rounded-lg ${getTypeColor(recommendation.type).split(" ")[0]}`}
                >
                ...
                <div className="flex-1">
                  ...
                  {recommendation.targetGuest && (
                    <p className="text-sm font-medium text-accent">
                      Objetivo: {recommendation.targetGuest}
                    </p>
                  )}
                </div>
              </div>
