...
import { GuestProfile } from "@/components/admin/guests/guest-profile";
import { RecommendationEngine } from "@/components/admin/ai/recommendation-engine";
...
const mockGuest = {
  ...
  aiInsights: {
    spendingPattern:
      "Alto gasto en servicios adicionales, especialmente spa y restaurante",
    preferredSeason: "Primavera y Otoño - evita temporadas altas",
    upsellProbability: 85,
    churnRisk: "low" as const,
    nextVisitPrediction:
      "Probable visita en Noviembre 2025 basado en patrones históricos",
  },
};
...
const mockRecommendations = [
  {
    ...
    estimatedImpact:
      "Incremento del 40% en satisfacción y 25% en ingresos por estancia",
  },
  {
    id: "rec-002",
    ...
    description:
      "Crear paquete spa exclusivo basado en preferencias de relajación y tratamientos anteriores",
    confidence: 88,
  ...
  },
  {
    ...
    description:
      "Menú degustación especial con chef personalizado para huéspedes vegetarianos VIP",
    confidence: 78,
    ...
    estimatedImpact:
      "Diferenciación premium, incremento en recomendaciones del 30%",
  },
  {
    id: "rec-004",
    ...
    description:
      "Ofrecer beneficios exclusivos para mantener engagement de huéspedes gold",
    confidence: 95,
    ...
    estimatedImpact:
      "Reducción del 60% en riesgo de churn, incremento en frecuencia de visitas",
  },
  {
    id: "rec-005",
    ...
    description:
      "Ajustar precios basado en demanda predictiva y comportamiento de huéspedes similares",
    confidence: 82,
    potentialRevenue: 3200,
    priority: "high" as const,
    category: "revenue",
    actionRequired:
      "Implementar algoritmo de pricing dinámico para próximas 2 semanas",
