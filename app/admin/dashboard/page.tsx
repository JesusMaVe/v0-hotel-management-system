...
import { OccupancyChart } from "@/components/admin/dashboard/occupancy-chart";
  ...
  return (
    <div className="flex flex-col h-full">
      <Header
        ...
        subtitle="Resumen en tiempo real de Villa Magna Family Resorts"
      />
          ...
          <div className="bg-card rounded-xl border border-border p-6">
            ...
            <div className="space-y-3">
              {[
                {
                  type: "Mantenimiento",
                  message: "Habitación 203 - A/C no funciona",
                  priority: "high",
                },
                {
                  type: "Overbooking",
                  message: "Suite Ejecutiva - 2 reservas extras",
                  priority: "critical",
                },
                {
                  type: "No-show",
                  message: "Reserva #1234 - Sin confirmar",
                  priority: "medium",
                },
              ].map((alert, index) => (
                <div
            ...
            <div className="space-y-4">
              ...
              <div className="p-3 rounded-lg bg-success/10 border border-success/20">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Aumentar tarifas 15% para el fin de semana debido a alta
                  demanda prevista
                </p>
              </div>
            </div>
